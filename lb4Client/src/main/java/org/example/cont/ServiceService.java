 ...
 * 
 */
@WebServiceClient(name = "ServiceService", targetNamespace = "http://example.org/", wsdlLocation = "http://localhost:8078/WebServiceProj?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICESERVICE_QNAME = new QName("http://example.org/", "ServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8078/WebServiceProj?wsdl");
    ...
    public Service getServicePort() {
        return super.getPort(new QName("http://example.org/", "ServicePort"), Service.class);
    }
    ...
    public Service getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example.org/", "ServicePort"), Service.class, features);
    }
